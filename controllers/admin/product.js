...
exports.addProduct = async function (req, res) {
    try {
        ...
        if (category.markedForDeletion) return res.status(404).json({ message: 'Category marked for deletion, you cannot add product to this category' });
    ...
    try {
        ...
        if (req.body.category) {
            ...
            if (category.markedForDeletion) {
                return res.status(404).json({ message: 'Category marked for deletion, you cannot add product to this category' });
            }
...
exports.deleteProductImages = async function (req, res) {
    try {
        ...
        if (!mongoose.isValidObjectId(req.params.id) || !Array.isArray(deletedImageUrls)) {
